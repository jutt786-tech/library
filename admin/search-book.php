                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php $sql = "SELECT tb.BookName,tc.CategoryName,ta.AuthorName,tb.ISBNNumber,tb.BookPrice,tb.id as bookid from  tblbooks tb
 inner join tblcategory as tc on tc.id=tb.CatId
 inner join tblauthors as ta on ta.id=tb.AuthorId 
where BookName LIKE '%$bname%'";
