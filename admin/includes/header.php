<div class="navbar navbar-inverse set-radius-zero" >
        <div class="container">
            ...
            <div class="search-container">
                <form action="search-book.php" method="GET">
                  <span><input type="text"  placeholder="Search Book.." name="BookName">
                  <button type="submit" name="submit"><i class="fa fa-search"></i></button></span>
                </form>
            </div>
 ...
 <li>
                           ...
                           <li>
                             ...
                             <li><a href="../admin/signup.php">User Signup</a></li>
